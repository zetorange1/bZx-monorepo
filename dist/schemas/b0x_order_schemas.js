...
exports.lendOrderSchema = {
    ...
    required: ['b0x', 'maker', 'lendTokenAddress', 'interestTokenAddress', 'marginTokenAddress', 'feeRecipientAddress', 'lendTokenAmount', 'interestAmount', 'initialMarginAmount', 'liquidationMarginAmount', 'lenderRelayFee', 'traderRelayFee', 'expirationUnixTimestampSec', 'salt'],
    type: 'object'
};

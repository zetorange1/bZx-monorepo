...
exports.noop = exports.generatePseudoRandomSalt = undefined;
...
var generatePseudoRandomSalt = utils.generatePseudoRandomSalt;
exports.generatePseudoRandomSalt = generatePseudoRandomSalt;
var noop = utils.noop;
exports.noop = noop;

var B0xJS = function B0xJS() {
...
exports.generatePseudoRandomSalt = exports.noop = undefined;
...
var generatePseudoRandomSalt = exports.generatePseudoRandomSalt = function generatePseudoRandomSalt() {
  ...
  var randomNumber = _bignumber2.default.random(MAX_DIGITS_IN_UNSIGNED_256_INT);
  var factor = new _bignumber2.default(10).pow(MAX_DIGITS_IN_UNSIGNED_256_INT - 1);

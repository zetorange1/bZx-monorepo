...
describe("tokenRegistry", () => {
  describe("getTokenList", async () => {
    test("should return formatted list of tokens including bZxToken", async () => {
      const expected = {
        address: Contracts.BZxToken.address.toLowerCase(),
      ...
      const [token] = await bZxJS.getTokenList();

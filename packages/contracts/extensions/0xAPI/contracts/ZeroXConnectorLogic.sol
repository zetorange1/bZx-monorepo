...
contract ZeroXConnectorLogic is Ownable {
    ...
    address public constant ZeroXExchange = 0x4eacd0aF335451709e1e7B570B8Ea68EdEC8bc97;
    address public constant ZeroXProxy = 0xF1eC01d6236D3CD881a0bF0130eA25fe4234003E;*/
        ...
        returns (address)
    {
        ...
        uint256 protocolFee;
        //uint256 offchainRate;
        //(affiliateWallet, protocolFee, offchainRate, loanDataBytes) = _process0xData(
        ...
        }/* else if (offchainRate != 0) {
            tmpAmount = sourceTokenAmount
                .mul(offchainRate);
            tmpAmount = tmpAmount
                .div(10**20);

            // reduce the total amount we are buying if not enough sourceToken is available
            if (tmpAmount < destTokenAmount) {
                destTokenAmount = tmpAmount;
            }
        }*/
   ...
   function _settleBalances(
        ...
        returns (address, uint256, bytes memory)
    {
        ...
        assembly {
            ...
            // get offchainRate
            //offchainRate := mload(add(loanDataBytes, sub(dataLength, 64)))
        ...
        //return (affiliateWallet, protocolFee, offchainRate, loanDataBytes);

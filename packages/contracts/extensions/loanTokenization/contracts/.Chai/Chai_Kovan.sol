...
contract Chai {
    // --- Data ---
    VatLike  public vat = VatLike(0xbA987bDB501d131f766fEe8180Da5d81b34b69d9);
    PotLike  public pot = PotLike(0xEA190DBDC7adF265260ec4dA6e9675Fd4f5A78bb);
    JoinLike public daiJoin = JoinLike(0x5AA71a3ae1C0bd6ac27A1f28e1415fFFB6F15B8c);
    GemLike  public daiToken = GemLike(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa);
    ...
    constructor() public {
        DOMAIN_SEPARATOR = keccak256(abi.encode(
			...
			keccak256(bytes(name)), keccak256(bytes(version)), 42, address(this))
        );

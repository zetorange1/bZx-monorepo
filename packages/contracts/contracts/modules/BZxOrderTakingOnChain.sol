...
contract BZxOrderTakingOnChain is BZxStorage, BZxProxiable, OrderTakingFunctions {
    ...
    function initialize(
        ...
        onlyOwner
    {
        targets[bytes4(keccak256("pushLoanOrderOnChain(address[6],uint256[10],bytes)"))] = _target;
        ...
        targets[bytes4(keccak256("preSign(address,address[6],uint256[10],bytes)"))] = _target;
        targets[bytes4(keccak256("preSignWithHash(address,bytes32,bytes)"))] = _target;
        targets[bytes4(keccak256("getLoanOrderHash(address[6],uint256[10])"))] = _target;
